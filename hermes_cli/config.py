...
_EXTRA_ENV_KEYS = frozenset({
    ...
    "YUANBAO_APP_KEY", "YUANBAO_APP_SECRET", "YUANBAO_API_DOMAIN", "YUANBAO_WS_URL",
    "YUANBAO_WS_GATEWAY_URL", "YUANBAO_SIGN_TOKEN_URL",
    "YUANBAO_TOKEN", "YUANBAO_HOME_CHANNEL", "YUANBAO_HOME_CHANNEL_NAME",
    "YUANBAO_ALLOWED_USERS", "YUANBAO_ALLOW_ALL_USERS", "YUANBAO_DM_POLICY",
    "YUANBAO_REQUIRE_MENTION",
